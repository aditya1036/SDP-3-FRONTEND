...
function PostDetails() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/api/post/getpostbyid/${id}`,    {
        headers: {
  ...
  return (
    ...
    <div>
{error &&  <Container style={{marginTop:"30px"}}> <Alert severity="error">
        <AlertTitle>Error</AlertTitle>
        This is an error — <strong>the page you are looking for doesn't exists</strong>
      </Alert></Container>}
...
<div>
      ...
      <Card elevation={4} style={{padding: "10px", minWidth: "70vh" }}>
        {/* SECOND CARD */}
          ...
          >
            <Avatar
             src={
              ...
              style={{ marginRight: "10px", width: "45px", height: "45px", border : "2px solid rgb(255, 255, 255)" }}
            ></Avatar>
            ...
            >
              <p style={{fontSize: "12px", color : "gray"}}>{timeString}</p>
            </div>
          </div>
